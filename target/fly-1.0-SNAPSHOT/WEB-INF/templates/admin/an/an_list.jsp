        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><i class="fa fa fa-bullhorn"></i> 公告管理 > 公告列表</h5>
                        ...
                        <table class="table table-striped">
                            ...
                            <c:forEach items="${requestScope.page.items}" var="o">
                                <tr>
                                    ...
                                    <td>${o.dates}</td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/AnnouncementController/edit?aid=${o.aid}" class="btn btn-white btn-sm" title="编辑"><i class="fa fa-pencil"></i> </a>
                                        <a href="javascript:;" class="btn btn-white btn-sm" title="删除" onclick="deleteFn(${o.aid});"><i class="fa fa-remove"></i> </a>
                                    </td>
                                </tr>
                            </c:forEach>
...
<script>
    ...
    function deleteFn(id) {
        ...
        parent.layer.confirm('确认删除？', {
            ...
            //icon: 1
               func: window.location = "${pageContext.request.contextPath}/AnnouncementController/delete?aid=" + id
            });
        }, function () {
            parent.layer.msg('取消', {
                shift: 6
    ...
    function getData(pageNo){
        window.location.href = "${pageContext.request.contextPath}/AnnouncementController/list?pageNoString=" + pageNo;
    }
