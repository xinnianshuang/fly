        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <h5><i class="fa fa fa-bullhorn"></i> 公告管理 > 公告更新</h5>
                ...
                <div class="ibox-content">
                    <form action="${pageContext.request.contextPath}/AnnouncementController/update" method="post" class="form-horizontal" >
                        <input type="hidden" name="method" value="update">
                        <input type="hidden" name="aid" id="aid" value="${requestScope.announcement.aid}">
