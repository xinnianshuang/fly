        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><i class="fa fa fa-plane"></i> 航班管理 > 航班列表</h5>
                        ...
                        <table class="table table-striped">
                            ...
                            <c:forEach items="${requestScope.page.items}" var="o">
                                <tr>
                                    ...
                                    <td>${o.end_time}</td>
                                    <td>${o.duration}</td>
                                    <td>${o.business_new}</td>
                                    <td>${o.economy_new}</td>
                                    <td>${o.eat}</td>

                                    <c:if test="${o.fly_status == '启用'}">
                                    <td style="color: #22bb22">${o.fly_status}</td>
                                    </c:if>
                                    <c:if test="${o.fly_status == '关闭'}">
                                        <td style="color: red">${o.fly_status}</td>
                                    </c:if>
                                    <td>

                                        <a href="${pageContext.request.contextPath}/FlyController/edit?fid=${o.fid}" class="btn btn-white btn-sm" title="编辑"><i class="fa fa-pencil"></i> </a>

                                        <a href="javascript:;" class="btn btn-white btn-sm" title="删除" onclick="deleteFn(${o.fid});"><i class="fa fa-remove"></i> </a>
                                    </td>
                                </tr>
                            </c:forEach>
...
<script>
    ...
    function deleteFn(id) {
        ...
        parent.layer.confirm('确认删除？', {
            ...
            //icon: 1
               func: window.location = "${pageContext.request.contextPath}/FlyController/delete?fid=" + id
            });
        }, function () {
            parent.layer.msg('取消', {
                shift: 6
    ...
    function getData(pageNo){
        ...
        window.location.href = "${pageContext.request.contextPath}/FlyController/list?pageNoString=" + pageNo+"&condition="+condition;
    }
