        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <h5><i class="fa fa fa-plane"></i> 航班管理 > 航班新增</h5>
                ...
                <div class="ibox-content">
                    <form action="${pageContext.request.contextPath}/FlyController/add" method="post" class="form-horizontal">
                        ...
                        <div class="form-group text-left">
                            <div class="checkbox i-checks">
                                ...
                                <label class="no-padding">
                                    <input type="radio" name="fly_status" value="启用" checked ${requestScope.fly.fly_status=='启用'?'checked':''}><i></i> 启用&nbsp;&nbsp;&nbsp;
